...
/**
 * Persistent class for entity stored in table "permisos"
 *
...
@Entity
@Table(name="permisos", schema="loggin", catalog="TAKEDA" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="Permisos.countAll", query="SELECT COUNT(x) FROM Permisos x" )
} )
