...
/**
 * Persistent class for entity stored in table "historico_password"
 *
...
@Entity
@Table(name="historico_password", schema="loggin", catalog="TAKEDA" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="HistoricoPassword.countAll", query="SELECT COUNT(x) FROM HistoricoPassword x" )
} )
public class HistoricoPassword implements Serializable {
